...
class PlaceAdapter(private val fragment: PlaceFragment, private val placeList: List<PlaceData>) : //List<City>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaceAdapter.ViewHolder {
        ...
        holder.itemView.setOnClickListener{
            ...
            if(activity is WeatherActivity){ //因为 placefragment 在 weatheractivity 中也做侧边菜单使用了
